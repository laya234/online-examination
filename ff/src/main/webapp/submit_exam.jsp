...
<%
    ...
    try {
        List<User> questionsList = (List<User>)UserDao.getAllRecordsForPython();
        ...
        switch (subject) {
            case "python":
                correctAnswersList = UserDao.getCorrectAnswersPy();
                break;
            case "c":
                correctAnswersList = UserDao.getCorrectAnswersC();
                break;
            case "DBMS":
                correctAnswersList = UserDao.getCorrectAnswersDBMS();
                break;
            case "aptitude":
